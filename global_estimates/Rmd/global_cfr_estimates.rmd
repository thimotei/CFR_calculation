...
```{r include = TRUE, fig.width = 13, fig.height = 20}
  ...
  ggplot2::coord_flip()
```
*Plot 1: Plotting the estimates for the proportion of symptomatic cases reported in different countries using cCFR estimates. Dark blue shading is the 25% - 75% confidence range and light blue is 2.5% - 97.5% confidence range*
