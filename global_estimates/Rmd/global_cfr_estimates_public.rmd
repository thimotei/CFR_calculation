...
```{r include = TRUE, fig.width = 13, fig.height = 10}
  ...
  ggplot2::theme(axis.text.x  = element_text(angle = 0, size = 13), axis.text.y  = element_text(size = 13)) +
  ggplot2::theme(axis.title.x = element_text(angle = 0, size = 15), axis.title.y = element_text(size = 15)) +
